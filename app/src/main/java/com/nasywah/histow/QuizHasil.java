...
public class QuizHasil extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(QuizHasil.this,Daftar.class);
                startActivity(i);
                finish();
            }
        });
        ...
        replay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(QuizHasil.this,QuizPilihan.class);
                startActivity(i);
                finish();
            }
        });
        ...
        mediaPlayer = MediaPlayer.create(QuizHasil.this,R.raw.win);
