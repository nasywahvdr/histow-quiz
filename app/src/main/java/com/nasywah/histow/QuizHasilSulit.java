...
public class QuizHasilSulit extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_quiz_hasilb);
        ...
        menu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(QuizHasilSulit.this,Daftar.class);
                startActivity(i);
                finish();
            }
        });
        ...
        replay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(QuizHasilSulit.this,QuizSulit.class);
                startActivity(i);
                finish();
            }
        });
        ...
        mediaPlayer = MediaPlayer.create(QuizHasilSulit.this,R.raw.win);
